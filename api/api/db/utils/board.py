...
def get_owned_boards(session: Session, user_id: int | None) -> list[Board]:
    from .. import Board
...
def get_shared_boards(session: Session, user_id: int | None) -> list[Board]:
    from .. import Board, BoardUserAccess
    ...
    return get_owned_boards(session, user_id) + shared


def create_board(session: Session, owner: User, **kwargs) -> Board:
    from .. import Board
