...
async def get_board_tags(board: api.dependencies.BoardOwnerAccessDep):
...
async def get_tag(board_and_tag: api.dependencies.BoardTagDep):
    _, tag = board_and_tag
    return tag
...
async def update_tag(
    board_and_tag: api.dependencies.BoardTagDep,
...
async def delete_tag(board_and_tag: api.dependencies.BoardTagDep, session: api.dependencies.SessionDep) -> None:
    _, tag = board_and_tag
